...
class DatabaseSeeder extends Seeder {
	...
	public function run()
	{
		...
		$this->command->info('Bear App seed Finished');// show information in the command line after everything is run
	}
}
...
class BearAppSeeder extends Seeder{
	...
	// bear 3 is named Adobot. He is a polar bear. He drinks vodka.
 	...
 	$this->command->info('Bears are Alive');
   ...
   // we will use the variables we used to create the bears to get their id
 	...
 	$this->command->info('Bears are eating fish');	
